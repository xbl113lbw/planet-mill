<template>
    <div class="rule">
        ...
        <div class="wrap">
            ...
            <div class="content">
                <div class="line">
                    ...
                    <p>
                        浩瀚的宇宙，无边无际，它充满的神秘与向往。人类文明不断通过各种学习与探索，谋求对浩瀚宇宙多一点了解，从世界四大文明古国开始，就不断的研究。华夏文明早在几千年前就对它总结“其外无边，其内无际”。
                    </p>
                </div>
                <div class="line">
                    <div class="left"></div>
                    <p>
                        人类地球的发展导致肆意的砍伐、战争、自然灾害及人为破坏，导致人类对自由、平等、财富、美好生活的向往。
                    </p>
                </div>
                <div class="line">
                    <div class="left"></div>
                    <p>
                        因此，人类需要自由、财富，平等、美好生活开始宇宙星球探索。
                    </p>
                </div>
            </div>
        </div>
        <div class="wrap">
            <div class="title">宇宙星球</div>
            <div class="content">
                <div class="line">
                    <img src="../../assets/img/deal/coin.png" class="left" alt=""/>
                    <p>
                        宇宙星球是人类追求自由、平等、财富、美好生活的共识联盟，通过认识量子、质子，探索宇宙奥秘、改变我们的生活环境
                    </p>
                </div>
            </div>
        </div>
        <div class="wrap">
            <div class="title">宇宙矿工</div>
            <div class="content">
                <div class="line">
                    <img src="../../assets/img/deal/coin.png" class="left" alt=""/>
                    <p>
                        宇宙矿工是人类参与追求财富自由、生活自由、美好生活的共识联盟，他根据个人对共识联盟体贡献值进行奖励。
                    </p>
                </div>
                <div class="line">
                    <img src="../../assets/img/deal/coin.png" class="left" alt=""/>
                    <p>
                        宇宙矿工是个人参与的权益证明，是对整个共识联盟的身份证明。
                    </p>
                </div>
            </div>
        </div>
        <div class="wrap">
            <div class="title">共识联盟</div>
            <div class="content">
                <div class="line">
                    <img src="../../assets/img/deal/coin.png" class="left" alt=""/>
                    <p>
                        共识联盟是打造一个财富自由、生活自由、美好生活的的生态环境。
                        <span class="bigText">沟通自由、财富自由、生活自由、交易自由</span>
                    </p>
                </div>
                <div class="line">
                    <img src="../../assets/img/deal/coin.png" class="left" alt=""/>
                    <p>
                        <span class="list">英文名称：<span>Consensus Alliance Chain</span></span>
                        <span class="list">简称：<span>CAC</span></span>
                        <span class="list">中文名称：<span>共识联盟链</span></span>
                        <span class="list">总量发行：<span>2.88亿枚</span></span>
                    </p>
                </div>
                <div class="line">
                    <img src="../../assets/img/deal/coin.png" class="left" alt=""/>
            ...
            <div class="content">
                ...
                <div class="line">
                    ...
                    <p>
                        质子（静态）<br/>
                        - 联盟哈希碰撞<br/>
                        - 每次需要100枚USDT根据链上时间戳进行哈希碰撞，根据时间戳的先后顺序，每到达4个碰撞为出矿一次，每次时间戳最后一个为成功者，奖励300枚CAC通证。<br/>
                        - 每60秒进行一次碰撞，每144000次碰撞后奖励开始递减，每次递减2%，以此类推。<br/>
                        - 其余三位奖励110枚USDT<br/>
                        - 每次参与哈希碰撞的用户需要燃效1个等值USDT的CAC通证，燃烧的通证直接进到链上黑通。<br/>
                    </p>
                </div>
                <div class="line">
                    <img src="../../assets/img/deal/coin.png" class="left" alt=""/>
                    <p>
                        量子（动态）<br/>
                        - 联盟哈希碰撞<br/>
                        - 为了共识联盟生态问卷发展，针对参与用户和分享用户共建共识联盟生态，联盟生态系统进行生态贡献者进行奖励。<br/>
                        - 直接奖励碰撞金额3%的USDT<br/>
                        - 间接奖励碰撞金额0.5%的USDT，直接推荐几个那几层，最高可以拿5层。<br/>
                    </p>
                </div>
                <div class="line">
                    <img src="../../assets/img/deal/coin.png" class="left" alt=""/>
                    <p>
                        ...
                        <span class="percentage">参与奖励<span class="line"></span><span class="num">93%</span></span>
                        <span class="percentage">推荐奖励<span class="line"></span><span class="num">1%</span></span>
                        <span class="percentage">共识联盟生态（二级市场）<span class="line"></span><span
                                class="num">5%</span></span>
                        <span class="percentage">星球矿主<span class="line"></span><span class="num">21%</span></span>
        ...
        <div class="wrap">
            <div class="title">财富自由交易</div>
            <div class="content">
                <div class="line">
                    <img src="../../assets/img/deal/coin.png" class="left" alt=""/>
                    <p>
                        共识联盟倡导交易自由，财富自由，所有交易价格将采用链上直接碰撞。交易在自己钱包进行。
                    </p>
                </div>
                <div class="line">
                    <img src="../../assets/img/deal/coin.png" class="left" alt=""/>
        ...
        <ul class="lists">
            <li>
                <div class="top">
                    <div class="left">
                        <div class="imgWrap">
                            <img src="../../assets/img/rule/Mercury.png" alt=""/>
                            <span>水星</span>
                        </div>
                        <span class="name">水星矿主</span>
                    </div>
                    <div class="right">
                        <div>
                            <span>投入CAC数量：</span>
            ...
            <li>
                <div class="top">
                    <div class="left">
                        <div class="imgWrap">
                            <img src="../../assets/img/rule/Mars.png" alt=""/>
                            <span>火星</span>
                        </div>
                        <span class="name">火星矿主</span>
                    </div>
                    <div class="right">
                        <div>
                            <span>投入CAC数量：</span>
            ...
            <li>
                <div class="top">
                    <div class="left">
                        <div class="imgWrap">
                            <img src="../../assets/img/rule/Venus.png" alt=""/>
                            <span>金星</span>
                        </div>
                        <span class="name">金星矿主</span>
                    </div>
                    <div class="right">
                        <div>
                            <span>投入CAC数量：</span>
            ...
            <li>
                <div class="top">
                    <div class="left">
                        <div class="imgWrap">
                            <img src="../../assets/img/rule/Saturn.png" alt=""/>
                            <span>土星</span>
                        </div>
                        <span class="name">土星矿主</span>
                    </div>
                    <div class="right">
                        <div>
                            <span>投入CAC数量：</span>
